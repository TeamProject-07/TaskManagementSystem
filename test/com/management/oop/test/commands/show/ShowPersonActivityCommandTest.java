...
public class ShowPersonActivityCommandTest {
    ...
    public void before() {
        ...
        this.person=new PersonImpl("PersonName");
    ...
    public void should_ThrowException_WhenPerson_DoesNotExist() {
        //Arrange
        List<String> params=List.of("invalidName");
        //Act, Assert
        Assertions.assertThrows(IllegalArgumentException.class, ()->showPersonActivity.execute(params));
    }
    @Test
    public void should_OutputMessageWhen_PersonDoesHas_Activity(){
        //Arrange
        List<String> params=List.of("personName");
        //Act
        String result=showPersonActivity.execute(params);
        //Assert
        Assertions.assertTrue(result.contains("personName"));
    }
}
